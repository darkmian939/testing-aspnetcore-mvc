...
{
    public class EmployeesControllerValidationAccionCreateTests
    {
        private readonly Mock<IEmployeeRepository> _mockRepo;
        private readonly EmployeesController _controller;
         
        public EmployeesControllerValidationAccionCreateTests()
        {
        ...
        [Fact]
        public void Create_ActionExecutes_returnsViewsForCreate()
        {
        ...
        {
            _controller.ModelState.AddModelError("Name", "Name is requiered");
        ...
        [Fact]
        public void Create_ModelStateVaild_CreateEmployeeCalledOnce()
        {
            Employee emp = null;
            _mockRepo.Setup(r => r.CreateEmployee(It.IsAny<Employee>()))
                .Callback<Employee> (x => emp = x);
